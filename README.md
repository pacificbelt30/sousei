...
- モデル再考 -> 性別やよみがなを追加した．講義回数を数えるやつを足した o
- グラフのフォーマット o
    - 出席率・遅刻率・の折れ線グラフまたは層になってる棒グラフ
    - 個人の棒グラフ
- フィルタの仕様 x 自分の環境ではまだ動かない
    - n回目フィルタ
    - 人名フィルタ
    - 学籍番号フィルタ
- スレッドを止める方法 or inputを止める方法
- printをちゃんと書きましょう 
- window.crypto.subtleはhttp環境で違うIPアドレスからのリクエストだと使えないっぽい？ o
- なんか知らないけどちょくちょくデータベースとの接続が切れるのでなんとかする 三角 よくわからん
- 高速化(自己満足ではなく仕様を満たすために必要) 
- フィルタ x
- パスワード変更 o
- データベースパスワード 

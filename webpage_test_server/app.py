...
def syusseki_all(kamoku):
    ...
    return render_template('syukketu3.html',kyoin=kyoin,table_header=table_header,syusseki_data=sorted(tmplist,key=lambda x: x[0]),risyu_list=risyu_list,kamoku_data=kamoku_data)
